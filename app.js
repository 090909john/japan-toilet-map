...
const state = {
  ...
  debounceTimer: null,
  originFromGPS: false, // true = GPS 定位；false = 文字搜尋或地圖中心，導航需帶 origin
};
...
function renderCard(place) {
  ...
  const navUrl = (!state.originFromGPS && state.queryCenter)
    ? `https://www.google.com/maps/dir/?api=1&origin=${state.queryCenter.lat},${state.queryCenter.lng}&destination=${place.lat},${place.lng}`
